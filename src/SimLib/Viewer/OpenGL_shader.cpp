...
bool igl::viewer::OpenGL_shader::init_from_files(
...
bool igl::viewer::OpenGL_shader::init(
...
void igl::viewer::OpenGL_shader::bind()
{
  glUseProgram(program_shader);
}

GLint igl::viewer::OpenGL_shader::attrib(const std::string &name) const
{
  return glGetAttribLocation(program_shader, name.c_str());
}

GLint igl::viewer::OpenGL_shader::uniform(const std::string &name) const
{
  return glGetUniformLocation(program_shader, name.c_str());
}

GLint igl::viewer::OpenGL_shader::bindVertexAttribArray(
...
void igl::viewer::OpenGL_shader::free()
{
  if (program_shader)
  {
...
GLuint igl::viewer::OpenGL_shader::create_shader_helper(GLint type, const std::string &shader_string)
{
  using namespace std;
