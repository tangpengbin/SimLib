...
void igl::viewer::OpenGL_state::init_buffers()
{
...
void igl::viewer::OpenGL_state::free_buffers()
{
...
void igl::viewer::OpenGL_state::set_data(const igl::viewer::ViewerData &data, bool invert_normals)
{
...
void igl::viewer::OpenGL_state::bind_mesh()
{
  glBindVertexArray(vao_mesh);
  shader_mesh.bind();
...
void igl::viewer::OpenGL_state::bind_overlay_lines()
{
...
void igl::viewer::OpenGL_state::draw_mesh(bool solid)
{
...
void igl::viewer::OpenGL_state::draw_overlay_lines()
{
  glDrawElements(GL_LINES, lines_F_vbo.cols(), GL_UNSIGNED_INT, 0);
}

void igl::viewer::OpenGL_state::draw_overlay_points()
{
  glDrawElements(GL_POINTS, points_F_vbo.cols(), GL_UNSIGNED_INT, 0);
}

void igl::viewer::OpenGL_state::init()
{
...
void igl::viewer::OpenGL_state::free()
{
  shader_mesh.free();
