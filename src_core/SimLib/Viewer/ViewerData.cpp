...
igl::viewer::ViewerData::ViewerData()
: dirty(DIRTY_ALL)
{
  clear();
};

void igl::viewer::ViewerData::set_face_based(bool newvalue)
{
...
void igl::viewer::ViewerData::set_mesh(const Eigen::MatrixXd& _V, const Eigen::MatrixXi& _F)
{
  using namespace std;
...
void igl::viewer::ViewerData::set_vertices(const Eigen::MatrixXd& _V)
{
  V = _V;
...
void igl::viewer::ViewerData::set_normals(const Eigen::MatrixXd& N)
{
  using namespace std;
  if (N.rows() == V.rows())
  {
...
void igl::viewer::ViewerData::set_colors(const Eigen::MatrixXd &C)
{
  using namespace std;
...
void igl::viewer::ViewerData::set_uv(const Eigen::MatrixXd& UV)
{
  using namespace std;
  if (UV.rows() == V.rows())
  {
...
void igl::viewer::ViewerData::set_uv(const Eigen::MatrixXd& UV_V, const Eigen::MatrixXi& UV_F)
{
  set_face_based(true);
...
void igl::viewer::ViewerData::set_texture(
...
void igl::viewer::ViewerData::set_points(
...
void igl::viewer::ViewerData::add_points(const Eigen::MatrixXd& P,  const Eigen::MatrixXd& C)
{
...
void igl::viewer::ViewerData::set_edges(
  const Eigen::MatrixXd& P,
...
void igl::viewer::ViewerData::add_edges(const Eigen::MatrixXd& P1, const Eigen::MatrixXd& P2, const Eigen::MatrixXd& C)
{
...
void igl::viewer::ViewerData::add_label(const Eigen::VectorXd& P,  const std::string& str)
{
...
void igl::viewer::ViewerData::clear()
{
...
void igl::viewer::ViewerData::compute_normals()
{
...
void igl::viewer::ViewerData::uniform_colors(const Eigen::Vector3d& ambient, const Eigen::Vector3d& diffuse, const Eigen::Vector3d& specular)
{
...
void igl::viewer::ViewerData::uniform_colors(const Eigen::Vector4d& ambient, const Eigen::Vector4d& diffuse, const Eigen::Vector4d& specular)
{
...
void igl::viewer::ViewerData::grid_texture()
{
